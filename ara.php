...
?>
        ...
        <div class="page-title">
            ...
            <div class="breadcrumb float-left">
                <ul>
                    ...
                    <li class="active"><a href="#"><?=$q?> kelimesine göre arama sonuçları</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div id="blog" class="grid-layout post-3-columns m-b-30" data-item="post-item">
            ...
            <?php
                        ...
                        $sorgu2 = $db->prepare("SELECT * FROM yazilar INNER JOIN kategoriler ON kategoriler.id = yazilar.yazi_kat_id WHERE yazi_durum=:d AND yazi_baslik LIKE :baslik ORDER BY yazi_tarih DESC LIMIT :goster, :lim");
                        $sorgu2->bindValue(":d", 1, PDO::PARAM_INT);
                        $sorgu2->bindValue(":baslik", '%'.$q.'%', PDO::PARAM_STR);
        ...
        <ul class="pagination">
            <?php 
                if($toplam > $lim){
                    pagination($s,ceil($toplam/$lim),'ara.php?q='.$q.'&sayfa=');
                }
                ?>
        </ul>
        <?php
