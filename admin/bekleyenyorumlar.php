    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Bekleyen Yorum Listesi</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Yorumlar</li>
          <li class="breadcrumb-item active"><a href="#">Bekleyen Yorum Listesi</a></li>
        </ul>
      </div>
      <div class="row">
      <?php
                  ...
                  $toplam = say('yorumlar','yorum_durum',0); // toplam yorum sayısını verir.
                  $lim = 10;
                  $goster = $s * $lim - $lim;
                  # Sayfalama
                  ...
                  $yorumlar->bindValue(':d',0,PDO::PARAM_INT);
                  $yorumlar->execute();
        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <h3 class="tile-title">Bekleyen Yorum Listesi (<?=say('yorumlar','yorum_durum',0)?>)</h3>
