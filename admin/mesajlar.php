                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><b><?=$yazi['yazi_goruntulenme']?></b></td>
                      <td><a href="<?=$yonetim.'/islemler.php?islem=yaziduzenle&id='.$yazi['yazi_id']?>"><i class="fa fa-edit"></i></a> | <a onclick="return confirm('Kategori silindiği zaman bu kategoriye ait tüm konular pasif duruma gelecektir onaylıyor musunuz ?');" href="<?=$yonetim.'/islemler.php?islem=yazisil&id='.$yazi['yazi_id']?>"><i class="fa fa-eraser"></i></a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
