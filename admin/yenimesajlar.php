...
<?php require_once 'inc/sol.php'; ?>
    ...
    <main class="app-content">
      ...
      <?php
                  ...
                  $toplam = say('mesajlar','durum',2); // toplam kategori sayısını verir.
                  $lim = 10;
                  $goster = $s * $lim - $lim;
                  # Sayfalama
                  ...
                  $mesajlar->bindValue(':d',2,PDO::PARAM_INT);
                  $mesajlar->execute();
        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <h3 class="tile-title">Yeni Mesaj Listesi (<?=say('mesajlar','durum','2')?>)</h3>
